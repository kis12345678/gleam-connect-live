...
import { ArrowLeft, Camera, Save, User, LogOut, Trash2 } from "lucide-react";
...
export default function Settings({ onBack }: Props) {
  ...
  const handleDeleteAccount = async () => {
    if (!confirm("Are you sure you want to sign out? This action will log you out.")) return;
    await signOut();
  };
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 max-w-lg mx-auto w-full">
        ...
        <div className="space-y-4">
          ...
          <Button variant="outline" onClick={handleDeleteAccount} className="w-full gap-2 text-destructive hover:text-destructive">
